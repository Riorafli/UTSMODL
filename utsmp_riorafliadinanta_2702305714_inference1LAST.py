...
def run_prediction(input_df):
    ...
    # Display prediction breakdown in Streamlit
    ...
    # Print the prediction and probability to the console for Test Case
...
def booking_app():
    ...
    with col1:
        if st.button("🔮 Predict Test Case 1 - Aman"):
        ...
        with col2:
            if st.button("🔮 Predict Test Case 2 - Potensi Cancel"):
