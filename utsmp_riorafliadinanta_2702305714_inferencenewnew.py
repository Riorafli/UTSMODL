...
def load_pickle_file(path):
    with open('/content/best_model_compressed.pkl', 'rb') as file:
        return pk.load(file)
...
def run_prediction(input_df):
    classifier = load_pickle_file("best_model_compressed")
...
def booking_app():
    ...
    # TEST CASES BELOW THE PREDICTOR
    st.markdown("---")
    ...
    with col1:
        if st.button("Run Test Case 1 - Aman"):
    ...
    with col2:
        if st.button("Run Test Case 2 - Potensi Cancel"):
