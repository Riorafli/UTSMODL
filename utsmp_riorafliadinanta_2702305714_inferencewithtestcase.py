...
def booking_app():
    ...
    test_case = st.selectbox("Select Test Case", ["Manual Input", "Test Case 1 - Aman", "Test Case 2 - Potensi Cancel"])
    ...
    elif test_case == "Test Case 1 - Aman":
        final_input = pd.DataFrame([{
            'adults': 2,
            'children': 0,
            'weekend_stays': 1,
    ...
    elif test_case == "Test Case 2 - Potensi Cancel":
        final_input = pd.DataFrame([{
            'adults': 1,
            'children': 1,
            'weekend_stays': 1,
